...
/* {reg_off,    bits_mask,  lock_bits,  init_val,    init_mask } */
    {CLKOFF,      CLKOFF_GM2D,  CLKOFF_GM2D,   0,  0},    // on/off
    {CLKSEL,      CLKSEL_GM2D,  CLKSEL_GM2D,   0,  0},    // 0:hclk/2 1:hclk
    {CLKRST,      CLKRST_GM2D,  CLKRST_GM2D,   0,  0},    // active low
};
