 ...
 *
 * $Revision: 1.2 $
 * $Date: 2015/03/23 06:23:57 $
 *
 * ChangeLog:
 *  $Log: en331.c,v $
 *  Revision 1.2  2015/03/23 06:23:57  shawn_hu
 *  Update EN331_DEV_MAX from 4 to 8 for GM8210 platform.
 *
...
static ushort vport[DEV_MAX] = {0x0001, 0x0002, 0x0003, 0x0004, 0x0005, 0x0006, 0x0007, 0x0008};
