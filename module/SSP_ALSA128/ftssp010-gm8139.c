/**
 * @file ftssp010-gm8139.c
 * Grain Media's SSP PMU settings of GM8139 series SOC
 *
 *
 */
...
/*
  ...
  retain this definition for further usage in 8139
*/
#define CLK_SRC_12288K  0
/*
  8139 does not have SSP2(only SSP0 and SSP1), 
  this file is copy from ftssp010-gm8287.c 
  retain this definition for further usage in 8139
*/
...
/* reg_off,  bit_masks,   lock_bits,     init_val,   init_mask */
	...
	{0x28,  0x0004c002,   0,      0,   	0},  //SSP0-1 select 12M as the source
    {0xb8,  0x3 << 4,     0,      0,    0},         //SSP0-2 pclk & sclk
	{0x74,	(0x3f << 8) | (0x3f),	  0,	(0x2c << 8) | (0x2c),	(0x3f << 8) | (0x3f)}
