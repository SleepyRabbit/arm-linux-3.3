...
//    {0x030D, 0xA0},
    ...
    {0x0343, 0x84},
#else
//    {0x030D, 0x6f}, //PLL_MPY , 30fps
    {0x030D, 0x25}, //PLL_MPY , 10fps
    {0x0340, 0x07}, //FRM_LENGTH
    {0x0341, 0x99},
    {0x0342, 0x0D}, //LINE_LENGTH
    {0x0343, 0x60},
#endif
    //3280x1845 => 41/16 => 1280x720
    {0x0344, 0x00}, //X_ADD_STA
    {0x0345, 0x00},
    {0x0346, 0x01}, //Y_ADD_STA
    {0x0347, 0x34},
    {0x0348, 0x0C}, //X_ADD_END
    {0x0349, 0xCF},
    {0x034A, 0x08}, //Y_ADD_END
    {0x034B, 0x68},
    {0x034C, 0x05}, //X_OUT_SIZE     //1280
    {0x034D, 0x00},
    {0x034E, 0x02}, //Y_OUT_SIZE     //720
    {0x034F, 0xD0},
    {0x0383, 0x01},
    {0x0387, 0x01},
    {0x0390, 0x00},
    {0x0401, 0x02},
    {0x0405, 0x29}, // scale m/n = 41/16
...
//    {0x030D, 0xA0},
    ...
    {0x034A, 0x08}, //Y_ADD_END
    {0x034B, 0x6B},
    {0x034C, 0x07}, //X_OUT_SIZE     //1942
    {0x034D, 0x96},
    {0x034E, 0x04}, //Y_OUT_SIZE     //1094
    {0x034F, 0x46},
    {0x0383, 0x01},
    {0x0387, 0x01},
    {0x0390, 0x00},
    {0x0401, 0x02},
    {0x0405, 0x1B}, // scale m/n = 27/16
