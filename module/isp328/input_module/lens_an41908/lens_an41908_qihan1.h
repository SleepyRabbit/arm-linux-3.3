...
// --------------------------------------------------------------------------------------------------------------------------------
#define LENS_NAME                  "PANA-AN41908"
#define LENS_ID                    "quhan1-v10"       // *


// config GPIO --------------------------------------------------------------------------------------------------------------------
#define SPI_PANASONIC_CS_PIN       GPIO_ID(0, 14)     // *
#define SPI_PANASONIC_RXD_PIN      GPIO_ID(0, 15)     // *
#define SPI_PANASONIC_TXD_PIN      GPIO_ID(0, 16)     // *
#define SPI_PANASONIC_CLK_PIN      GPIO_ID(0, 17)     // *
#define AN41908_VD_FZ_PIN          GPIO_ID(0, 1)      // *
#define AN41908_RESET_PIN          -1                 // *

#ifndef FZ_PLS_PIN_EXIST
#define MOT_FOCUS_PLS_PIN          37
#define MOT_ZOOM_PLS_PIN           38
#define FOCUS_PSUM_DELAY           28                 // unit: msec (12*AN41908_MOTOR1_STEP_CYCLE/27MHz)*255=26 msec
#define ZOOM_PSUM_DELAY            55                 // unit: msec (12*AN41908_MOTOR2_STEP_CYCLE/27MHz)*255=52 msec
#else
#define MOT_FOCUS_PLS_PIN          GPIO_ID(0, 31)    // *
#define MOT_ZOOM_PLS_PIN           GPIO_ID(1, 26)    // *
...
#define NEAR_BOUND                 0                 // *
#define INF_BOUND                  1510              // *
#define WIDE_BOUND                 0                 // *
#define TELE_BOUND                 600               // *
#define WIDE_FOCAL_VALUE           28                // * 2.8  mm
#define TELE_FOCAL_VALUE           120               // * 12.0 mm
#define INIT_FOCUS_POS             180               // *
#define INIT_ZOOM_POS              23                // *

#define FOCUS_BACKLASH_CORR        15                // * correction for focus backlash
#define ZOOM_BACKLASH_CORR         15                // * correction for zoom backlash
...
static pmuReg_t lens_pmu_reg[] = {
    ...
    */
    ...
    {
     .reg_off   = 0x54,    // *
     .bits_mask = BIT21 | BIT20 | BIT19 | BIT18 | BIT17 | BIT16 | BIT15 | BIT14,
     .lock_bits = BIT21 | BIT20 | BIT19 | BIT18 | BIT17 | BIT16 | BIT15 | BIT14,
     .init_val  = 0x00000000,
     .init_mask = BIT21 | BIT20 | BIT19 | BIT18 | BIT17 | BIT16 | BIT15 | BIT14,
    },
    ...
    {
     .reg_off   = 0x58,    // *
     .bits_mask = BIT17 | BIT16 | BIT15 | BIT14,
     .lock_bits = BIT17 | BIT16 | BIT15 | BIT14,
     .init_val  = 0x00000000,
     .init_mask = BIT17 | BIT16 | BIT15 | BIT14,
    },
#endif
};
