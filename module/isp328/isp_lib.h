...
extern u32  isp_read_mipi_reg(isp_dev_info_t *pdev_info, u32 offset);
extern void isp_write_mipi_reg(isp_dev_info_t *pdev_info, u32 offset, u32 val);
extern u32  isp_read_lvds_reg(isp_dev_info_t *pdev_info, u32 offset);
extern void isp_write_lvds_reg(isp_dev_info_t *pdev_info, u32 offset, u32 val);
...
extern void isp_dev_set_ce_bgwin(isp_dev_info_t *pdev_info, int bg0_hno, int bg0_vno, int bg1_hno, int bg1_vno);
...
extern int  isp_dev_gen_bin(isp_dev_info_t *pdev_info, char *cfg_path, char *bin_path);
extern int  isp_dev_load_bin(isp_dev_info_t *pdev_info);
extern void isp_dev_apply_cfg(isp_dev_info_t *pdev_info);
...
extern u32  isp_dev_get_sensor_min_exp_us(isp_dev_info_t *pdev_info);
extern u32  isp_dev_get_sensor_max_exp_us(isp_dev_info_t *pdev_info);
...
extern u32  isp_dev_check_sensor_status(isp_dev_info_t *pdev_info);
extern int  isp_dev_set_sensor_reset(isp_dev_info_t *pdev_info);

//=============================================================================
// vcap data range
//=============================================================================
extern int  isp_dev_get_vcap_yuv_range(isp_dev_info_t *pdev_info);
extern int  isp_dev_set_vcap_yuv_range(isp_dev_info_t *pdev_info, int range);
