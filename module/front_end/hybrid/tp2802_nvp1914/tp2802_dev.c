...
{
    return tp2802_nvp1914_i2c_read_ext(iaddr[id], reg);
}
...
int tp2802_get_vch_id(int id, TP2802_DEV_VOUT_T vout, int vin_ch)
{
    ...
    for(i=0; i<(dev_num*TP2802_DEV_CH_MAX); i++) {
        if((CH_IDENTIFY_ID(TP2802_NVP1914_VCH_MAP[i]) == id) &&
           (CH_IDENTIFY_VOUT(TP2802_NVP1914_VCH_MAP[i]) == vout) &&
           (CH_IDENTIFY_VIN(TP2802_NVP1914_VCH_MAP[i]) == vin_ch)) {
            return i;
        }
    }
...
static int tp2802_proc_vout_fmt_show(struct seq_file *sfile, void *v)
{
    ...
    for(i=0; i<TP2802_DEV_VOUT_MAX; i++) {
        for(j=0; j<(dev_num*TP2802_DEV_CH_MAX); j++) {
            if((CH_IDENTIFY_ID(TP2802_NVP1914_VCH_MAP[j]) == pdev->index) && (CH_IDENTIFY_VOUT(TP2802_NVP1914_VCH_MAP[j]) == i)) {
                ret = tp2802_video_get_video_output_format(pdev->index, CH_IDENTIFY_VIN(TP2802_NVP1914_VCH_MAP[j]), &vout_fmt);
