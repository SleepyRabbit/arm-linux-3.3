/**
 * @file nvp6114_lib.c
 * NextChip NVP6114 4CH AHD1.0 RX and 9CH Audio Codec Library (for hybrid design)
...
static int nvp6114_video_set_ch_960h(int id, int pal, int vport1_960H, int vport2_960H)
{
    int ret;
	...
	ret = nvp6114_i2c_write(id, 0x12, ((vport2_960H?0x03:0x00)<<2)|((vport1_960H?0x03:0x00))); if(ret < 0) goto exit;
	ret = nvp6114_i2c_write(id, 0x16, (vport1_960H?0x00:0x55)); if(ret < 0) goto exit;
	ret = nvp6114_i2c_write(id, 0x17, (vport2_960H?0x00:0x55)); if(ret < 0) goto exit;

	/************bank 4 diff setting *************/
	ret = nvp6114_i2c_write(id, 0xFF, 0x04); if(ret < 0) goto exit;
	ret = nvp6114_i2c_write(id, 0x5C, ((vport2_960H?0x00:0x0F)<<4)|(vport1_960H?0x00:0x0F)); if(ret < 0) goto exit;
	ret = nvp6114_i2c_write(id, 0x41, ((vport2_960H?0x00:0x03)<<2)|(vport1_960H?0x00:0x03)); if(ret < 0) goto exit;
    ...
    else if((vport1_960H == 0) && (vport2_960H == 0)) {
    	if(pal == 0) {
    		//============== FSC_EXT_VAL ===================//
    ...
    ret = nvp6114_i2c_write(id, 0x53, ((vport2_960H?0x03:0x00)<<2)|(vport1_960H?0x03:0x00)); if(ret < 0) goto exit;
    ret = nvp6114_i2c_write(id, 0x2C, (pal==1)?0x00:0x04); if(ret < 0) goto exit;
    if(vport1_960H == 0 && vport2_960H == 0) {
    	//================== Bank3 =====================//
    	ret = nvp6114_i2c_write(id, 0xff, 0x03); if(ret < 0) goto exit;
    ...
    ret = nvp6114_i2c_write(id, 0x45, ((vport2_960H?0x01:0x0B)<<4)|(vport1_960H?0x01:0x0B)); if(ret < 0) goto exit;
    ret = nvp6114_i2c_write(id, 0x47, ((vport2_960H?0x02:0x05)<<4)|(vport1_960H?0x02:0x05)); if(ret < 0) goto exit;
    ret = nvp6114_i2c_write(id, 0x50, ((vport2_960H?0x07:0x0D)<<4)|(vport1_960H?0x07:0x0D)); if(ret < 0) goto exit;
    ret = nvp6114_i2c_write(id, 0xD3, ((vport2_960H?0x00:0x03)<<2)|(vport1_960H?0x00:0x03)); if(ret < 0) goto exit;
