 ...
 *
 * $Revision: 1.6 $
 * $Date: 2015/01/16 06:04:07 $
 *
 * ChangeLog:
 *  $Log: tp2802_tw2964_hybrid_drv.c,v $
 *  Revision 1.6  2015/01/16 06:04:07  shawn_hu
 *  Fix a bug of the wrong video output setting during HD/SD switching when the device number of TP2802 is greater than 1.
 *
