 ...
 *
 * $Revision: 1.4 $
 * $Date: 2015/03/23 07:23:18 $
 *
 * ChangeLog:
 *  $Log: en331_drv.c,v $
 *  Revision 1.4  2015/03/23 07:23:18  shawn_hu
 *  Update EN331 driver for 8-CH application on GM8210 product.
 *
 *  Revision 1.3  2015/03/23 06:04:21  shawn_hu
 *  Update the wait time after a hardware reset from 100 to 500us (for GM8210/FA626 driver loading).
 *
 *  Revision 1.2  2015/01/20 05:49:27  shawn_hu
 *  Update some register setting which comes from Eyenix.
 *
...
/* device i2c address */
static ushort iaddr[EN331_DEV_MAX] = {0x84, 0x8C, 0x94, 0x9C, 0xC4, 0xCC, 0xD4, 0xDC};
...
static void en331_hw_reset(void)
{
    ...
    udelay(500); ///< It has to wait 500 micro seconds if this driver loaded by FA626 of GM8210
}
