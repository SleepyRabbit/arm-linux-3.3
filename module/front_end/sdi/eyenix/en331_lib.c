 ...
 *
 *  Revision 1.3  2015/01/20 05:49:27  shawn_hu
...
static int en331_pre_output_mode[EN331_DEV_MAX] = {-1, -1, -1, -1, -1, -1, -1, -1}; // Previous output mode: -1 -> Unknown
static int en331_cur_output_mode[EN331_DEV_MAX] = {0, 0, 0, 0, 0, 0, 0, 0}; // Current output mode: 0 -> black image, 1 -> EX-SDI, 2 -> HD-SDI
