 ...
 * VER1.2 2015/03/30 create polling thread by 200ms to detect ADDA clock if is changed
 *                   then change irda fiv factor fo 8136 only 
 * VER1.3 2015/03/31 use dynamic PLL1 CLK
 * VER1.4 2015/03/31 support PLL2 CLK
 *
 */
