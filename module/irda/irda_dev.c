...
extern u32 irda_get_irda_clk(void);
#endif
...
int Irdet_HwSetup(unsigned int base, int protocol, int gpio_num)
{
    ...
    switch(protocol)
    {
...
#if defined(CONFIG_PLATFORM_GM8136)
		{
			ir_div = irda_get_irda_clk();
			tmp_parm2 = (IRDET_PARAM2_RCA & 0xffffff00) | ir_div;	
			Irdet_SetParam2(base, tmp_parm2 | (gpio_num << CHANNEL_SELECT));
      ...
      case IRDET_SHARP:
		...
		{
			ir_div = irda_get_irda_clk();
			tmp_parm2 = (IRDET_PARAM2_SHARP & 0xffffff00) | ir_div;	
			Irdet_SetParam2(base, tmp_parm2 | (gpio_num << CHANNEL_SELECT));
      ...
      case IRDET_PHILIPS_RC5:
		...
		{
			ir_div = irda_get_irda_clk();
			tmp_parm2 = (IRDET_PARAM2_PHILIPS_RC5 & 0xffffff00) | ir_div;	
			Irdet_SetParam2(base, tmp_parm2 | (gpio_num << CHANNEL_SELECT));
      ...
      case IRDET_NOKIA_NRC17:
		...
		{
			ir_div = irda_get_irda_clk();
			tmp_parm2 = (IRDET_PARAM2_NOKIA_NRC17 & 0xffffff00) | ir_div;	
			Irdet_SetParam2(base, tmp_parm2 | (gpio_num << CHANNEL_SELECT));
      ...
      default:
		...
		{
			ir_div = irda_get_irda_clk();
			tmp_parm2 = (IRDET_PARAM2_NEC & 0xffffff00) | ir_div; 	
			Irdet_SetParam2(base, tmp_parm2 | (gpio_num << CHANNEL_SELECT));
