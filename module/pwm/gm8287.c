...
#define PWM5_6_PINMUX BIT4
#define PWM5_6_MASK (BIT3|BIT4)
#define PWM5_6_REG 0x50
#define PWM3_4_PINMUX BIT22
#define PWM3_4_MASK (BIT22|BIT23)
#define PWM3_4_REG 0x5c
#define PWM1_2_PINMUX BIT13
#define PWM1_2_MASK (BIT12|BIT13)
#define PWM1_2_REG 0x5c
static u8 pin_num_mapping[] = {
0, //pwm 0 
3, //pwm 1 --> pmu_reg [3]
3, //pwm 2 --> pmu_reg [3]
2, //pwm 3 --> pmu_reg [2]
...
static pmuReg_t pmu_reg[] = {
    ...
    {0xBC, BIT20, BIT20, 0, BIT20},    // PWM clock	
    {PWM5_6_REG, PWM5_6_MASK, PWM5_6_MASK, PWM5_6_PINMUX, PWM5_6_MASK},// PWM 5~6 pinmux
    {PWM3_4_REG, PWM3_4_MASK, PWM3_4_MASK, PWM3_4_PINMUX, PWM3_4_MASK},// PWM 3~4 pinmux
    {PWM1_2_REG, PWM1_2_MASK, PWM1_2_MASK, PWM1_2_PINMUX, PWM1_2_MASK},// PWM 1~2 pinmux
#endif
};
...
#endif
#if defined(CONFIG_PLATFORM_GM8287) 
    ftpmu010_write_reg(pwm_pmu_fd, 0xBC, BIT20, BIT20);
#endif
}
...
static void pwm_set_pinmux(int id)
{
    ...
    groupNum = pin_num_mapping[id];
    if(groupNum) {
        reg_offset = pmu_reg[groupNum].reg_off;
        mask = pmu_reg[groupNum].bits_mask;
        mode = pmu_reg[groupNum].init_val;
    } else {
        err("Error pwm num\n");
        return;
    }
...
void pwm_mode_change(int id, enum pwm_set_mode mode)
{
    ...
    pwm_reg_read(PWM_CTRL(id), &tmp);
#if defined(CONFIG_PLATFORM_GM8287)	//GM8287 only support  auto-reload mode
    tmp &= ~BIT4;		
    tmp |= (mode&0x1)<<4;
#endif
    pwm_reg_write(PWM_CTRL(id), tmp);
