...
static pmuReg_t pmu_reg[] = {
    ...
    {0x50, (0x3 << 8), (0x3 << 8), (0x2 << 8), (0x3 << 8)},// PWM 7 pinmux
    {0x50, (0x3 << 6), (0x3 << 6), (0x2 << 6), (0x3 << 6)},// PWM 6 pinmux
    {0x50, (0x3 << 4), (0x3 << 4), (0x2 << 4), (0x3 << 4)},// PWM 5 pinmux with UART2
    {0x50, (0x3 << 2), (0x3 << 2), (0x2 << 2), (0x3 << 2)},// PWM 4 pinmux with UART2

    {0x64, (0x3 << 18), (0x3 << 18), (0x1 << 18), (0x3 << 18)},// PWM 3 pinmux
    {0x64, (0x3 << 16), (0x3 << 16), (0x1 << 16), (0x3 << 16)},// PWM 2 pinmux
    {0x64, (0x3 << 14), (0x3 << 14), (0x1 << 14), (0x3 << 14)},// PWM 1 pinmux
    {0x64, (0x3 << 12), (0x3 << 12), (0x1 << 12), (0x3 << 12)},// PWM 0 pinmux
#endif
    ...
    //{0x54, (0x3 << 24), (0x3 << 24), (0x2 << 24), (0x3 << 24)},// PWM 3 pinmux with I2C
    //{0x54, (0x3 << 22), (0x3 << 22), (0x2 << 22), (0x3 << 22)},// PWM 2 pinmux with I2C
    {0x64, (0x3 << 14), (0x3 << 14), (0x1 << 14), (0x3 << 14)},// PWM 1 pinmux
    {0x64, (0x3 << 12), (0x3 << 12), (0x1 << 12), (0x3 << 12)},// PWM 0 pinmux
#endif
};
