...
/*
 *  Define main clock for SSP. 
 *  It must consistent with the SSP clock source definition in PMU. 
 *  It would affect the bit rate when SSP is master.
 */
#if defined(CONFIG_PLATFORM_GM8139) || defined(CONFIG_PLATFORM_GM8136)|| defined(CONFIG_PLATFORM_GM8287)
