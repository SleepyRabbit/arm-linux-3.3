...
/* set osd font edge mode*/
int api_osd_set_edge_mode(int fd, int type, osd_font_edge_t edge)
{
    int ret;

    switch(type) {
        case OSD_TYPE_CAP:
            ret = vcap_api_osd_set_font_edge_mode(fd, edge);
            break;
        case OSD_TYPE_SCL:
        default:
            return -1;
...
/* get osd font edge mode */
int api_osd_get_edge_mode(int fd, int type, osd_font_edge_t *edge)
{
    int ret;

    switch(type) {
        case OSD_TYPE_CAP:
            ret = vcap_api_osd_get_font_edge_mode(fd, (VCAP_API_OSD_FONT_EDGE_T *)edge);
            break;
        case OSD_TYPE_SCL:
        default:
            return -1;
...
int api_osd_frame_mode_enable(int fd, int type)
{
    int ret;

    switch(type) {
        case OSD_TYPE_CAP:
            ret = vcap_api_osd_frame_mode_enable(fd);
            break;
        case OSD_TYPE_SCL:
        default:
            return -1;
...
int api_osd_frame_mode_disable(int fd, int type)
{
    int ret;

    switch(type) {
        case OSD_TYPE_CAP:
            ret = vcap_api_osd_frame_mode_disable(fd);
            break;
        case OSD_TYPE_SCL:
        default:
            return -1;
...
EXPORT_SYMBOL(api_osd_set_edge_mode);
EXPORT_SYMBOL(api_osd_get_edge_mode);
...
EXPORT_SYMBOL(api_osd_frame_mode_enable);
EXPORT_SYMBOL(api_osd_frame_mode_disable);
