    ...
    Version 4.0.22: 1. handle bitstream overflow
                    2. rate control update
    Version 4.1.0: support VG2
	*/
    #define MJPEGE_VER			0x40200000
...
#ifdef SUPPORT_VG2
    #define MJE_MAX_CHANNEL     4
#else
    #define MJE_MAX_CHANNEL     32
#endif

    #define MJE_HANDLE_BITSTREAM_OVERFLOW
    #ifdef MJE_HANDLE_BITSTREAM_OVERFLOW
        #define MJE_BITSTREAM_FULL_STATE    0xFFFFFFF
    #endif
