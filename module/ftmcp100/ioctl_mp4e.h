    ...
    Version 4.0.20: 1. handle bitstream overflow
                    2. add module parameter of max channel
    */
	#define MP4E_VER            0x40001400
