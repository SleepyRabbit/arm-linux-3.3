...
/************ local used ************/
// encoder
extern int enc_init_mem_pool(int max_width, int max_height, unsigned int enc_max_chn);
...
// decoder
extern int dec_init_mem_pool(int max_width, int max_height, unsigned int dec_max_chn);
...
/************ export symbol ************/
extern int init_mem_pool(int max_width, int max_height, unsigned int enc_max_chn, unsigned int dec_max_chn);
