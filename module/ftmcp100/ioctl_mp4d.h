    ...
    Version 4.0.11: fix bug: chroma addres of reference frame error (use wrong resolution setting)
    Version 4.0.12: 1. add module parameter of max channel
                    2. check buffer size and resolution of decoded frame
                    3. add module parameter of max channel
	 */
	#define MP4D_VER            0x40000C00
