...
enum _adda302_power_cycle {
    ADDA302_ADC_POWER_CYCLE,
    ADDA302_DAC_POWER_CYCLE
};
...
void adda302_hw_reset(void);
void adda302_i2s_apply(void);
void adda302_power_cycle(enum _adda302_power_cycle target);
