 ...
 *
 * $Revision: 1.73 $
 * $Date: 2016/04/22 05:22:26 $
 *
 * ChangeLog:
 *  $Log: ioctl_isp320.h,v $
 *  Revision 1.73  2016/04/22 05:22:26  wattis_lee
 *  *** empty log message ***
 *
 *  Revision 1.72  2016/04/22 05:13:22  wattis_lee
 *  Add IOCTL function of get/set IR cut filter for lens driver
 *
 *  Revision 1.71  2015/11/23 06:24:03  wattis_lee
 *  Add an IOCTL function of getting current ISP FPS
 *
 *  Revision 1.70  2015/10/28 08:14:50  ricktsao
 *  *** empty log message ***
 *
 *  Revision 1.69  2015/09/10 07:23:52  pshung
 *  add ISP_IOC_GET_DEMON_VER command
 *
 *  Revision 1.68  2015/09/04 08:54:17  jason_ha
 *  add ae_get_current_gain IOCTL
 *
 *  Revision 1.67  2015/09/04 08:45:29  pshung
 *   add ISP_IOC_GET_VCAP_SIZE for isp_demon
 *
 *  Revision 1.66  2015/08/10 10:04:33  ricktsao
 *  add AE_IOC_GET_MIN_SENSOR_GAIN / AE_IOC_SET_MIN_SENSOR_GAIN
 *        AE_IOC_GET_MAX_SENSOR_GAIN / AE_IOC_SET_MAX_SENSOR_GAIN
 *
 *  Revision 1.65  2015/06/04 01:30:56  wattis_lee
 *  Add new ioctl command for setting zoom position
 *
 *  Revision 1.64  2015/06/02 03:28:01  wattis_lee
 *  Modify focus and zoom sample code
 *
 *  Revision 1.63  2015/05/20 08:11:09  wattis_lee
 *  Add enable/disable flag for AF backlash compensation function
 *
 *  Revision 1.62  2015/05/06 06:57:39  ricktsao
 *  add ISP_IOC_GET_DAYNIGHT_MODE / ISP_IOC_SET_DAYNIGHT_MODE
 *
 *  Revision 1.61  2015/04/08 03:12:31  jtwang
 *  add 3A status ioctl
 *
 *  Revision 1.60  2015/03/31 05:48:52  ricktsao
 *  add ISP_IOC_GET_ADJUST_DPC_EN and ISP_IOC_SET_ADJUST_DPC_EN
 *
 *  Revision 1.59  2015/03/19 01:51:51  jtwang
 *  add reset sensor, set exposure time and gain api
 *
 *  Revision 1.58  2015/03/12 04:35:43  ricktsao
 *  add ISP_IOC_GET_VCAP_YUV_RANGE / ISP_IOC_SET_VCAP_YUV_RANGE
 *
 *  Revision 1.57  2015/02/05 12:01:27  allenhsu
 *  add AE_IOC_SET_SYNC_WIN
 *
 *  Revision 1.56  2015/02/03 03:32:11  jtwang
 *  add LENS_IOC_GET_CHECK_BUSY control
 *
...
#define ISP_IOC_GET_VCAP_SIZE           _IOR(ISP_IOC_ISP, 24, struct win_size)  // for isp_demon
#define ISP_IOC_GET_DEMON_VER           _IOR(ISP_IOC_ISP, 25, u32)  // for isp_demon
#define ISP_IOC_GET_CURR_FPS            _IOR(ISP_IOC_ISP, 26, int)
...
#define ISP_IOC_GET_DAYNIGHT_MODE       _IOR(ISP_IOC_ISP, 201, int)
#define ISP_IOC_SET_DAYNIGHT_MODE       _IOW(ISP_IOC_ISP, 201, int)
#define ISP_IOC_GET_ADJUST_DPC_EN       _IOR(ISP_IOC_ISP, 200, int)
#define ISP_IOC_SET_ADJUST_DPC_EN       _IOW(ISP_IOC_ISP, 200, int)
...
#define ISP_IOC_GET_VCAP_YUV_RANGE      _IOR(ISP_IOC_ISP, 134, int)
#define ISP_IOC_SET_VCAP_YUV_RANGE      _IOW(ISP_IOC_ISP, 134, int)
...
#define ISP_IOC_SET_SENSOR_EXP_GAIN     _IOW(ISP_IOC_SENSOR, 20, u32)
#define ISP_IOC_SET_SENSOR_EXP_GAIN_US  _IOW(ISP_IOC_SENSOR, 21, u32)
#define ISP_IOC_SET_SENSOR_RESET        _IOW(ISP_IOC_SENSOR, 22, u32)
...
#define LENS_IOC_GET_IRCUT_STATE        _IOR(ISP_IOC_LENS, 11, int)
#define LENS_IOC_SET_IRCUT_STATE        _IOW(ISP_IOC_LENS, 12, int)
...
#define AWB_IOC_GET_STATUS              _IOR(ISP_IOC_AWB, 15, int *)
