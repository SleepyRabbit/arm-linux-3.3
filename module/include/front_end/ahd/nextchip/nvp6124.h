...
#define NVP6124_DEV_AUDIO_CH_MAX        8       ///< AIN#0~7
...
typedef enum {
    NVP6124_VMODE_1CH_BYPASS = 0,       ///< NTSC/PAL, 960H/AHD 720P/AFHD 1080P 
    NVP6124_VMODE_NTSC_960H_2CH,        ///< 37.125MHz D1   2 channel (dual edge)
    NVP6124_VMODE_NTSC_960H_4CH,        ///< 148.5MHz  D1   4 channel
    NVP6124_VMODE_NTSC_720P_2CH,        ///< 148.5MHz  720P 2 channel (dual edge)
    NVP6124_VMODE_PAL_960H_2CH,         ///< 74.25MHz  D1   2 channel (dual edge)
    NVP6124_VMODE_PAL_960H_4CH,         ///< 148.5MHz  D1   4 channel
    NVP6124_VMODE_PAL_720P_2CH,         ///< 148.5MHz  720P 2 channel (dual edge)

    /* Hybrid */
    NVP6124_VMODE_NTSC_960H_720P_2CH,   ///< VPORTA=>960H 2CH, VPORTB=>720P 2CH (dual edge)
    NVP6124_VMODE_NTSC_720P_960H_2CH,   ///< VPORTA=>720P 2CH, VPORTB=>960H 2CH (dual edge)
    NVP6124_VMODE_PAL_960H_720P_2CH,    ///< VPORTA=>960H 2CH, VPORTB=>720P 2CH (dual edge)
    NVP6124_VMODE_PAL_720P_960H_2CH,    ///< VPORTA=>720P 2CH, VPORTB=>960H 2CH (dual edge)

    /* CIF AHD/AFHD */
    NVP6124_VMODE_NTSC_CIF_AHD_2CH,     ///< 74.25MHz 
    NVP6124_VMODE_NTSC_CIF_AHD_4CH,     ///< 148.5MHz
    NVP6124_VMODE_PAL_CIF_AHD_2CH,      ///< 74.25MHz
    NVP6124_VMODE_PAL_CIF_AHD_4CH,      ///< 148.5MHz
    NVP6124_VMODE_NTSC_CIF_AFHD_2CH,    ///< 148.5MHz 1080*960 2 channel (dual edge)
    NVP6124_VMODE_PAL_CIF_AFHD_2CH,     ///< 148.5MHz 1080*960 2 channel (dual edge)
...
typedef enum {
    ...
    NVP6124_VFMT_AHD_CIF_P25,  // AHD  CIF   25FPS
    NVP6124_VFMT_AHD_CIF_P30,  // AHD  CIF   30FPS
    NVP6124_VFMT_AFHD_CIF_P25, // AFHD CIF   25FPS
    NVP6124_VFMT_AFHD_CIF_P30, // AFHD CIF   30FPS
    NVP6124_VFMT_MAX
} NVP6124_VFMT_T;
...
#define NVP6124_GET_MODE        _IOR(NVP6124_IOC_MAGIC,   2, int)
#define NVP6124_SET_MODE        _IOWR(NVP6124_IOC_MAGIC,  3, int)

#define NVP6124_GET_CONTRAST    _IOR(NVP6124_IOC_MAGIC,   4, struct nvp6124_ioc_data_t)
#define NVP6124_SET_CONTRAST    _IOWR(NVP6124_IOC_MAGIC,  5, struct nvp6124_ioc_data_t)

#define NVP6124_GET_BRIGHTNESS  _IOR(NVP6124_IOC_MAGIC,   6, struct nvp6124_ioc_data_t)
#define NVP6124_SET_BRIGHTNESS  _IOWR(NVP6124_IOC_MAGIC,  7, struct nvp6124_ioc_data_t)

#define NVP6124_GET_SATURATION  _IOR(NVP6124_IOC_MAGIC,   8, struct nvp6124_ioc_data_t)
#define NVP6124_SET_SATURATION  _IOWR(NVP6124_IOC_MAGIC,  9, struct nvp6124_ioc_data_t)

#define NVP6124_GET_HUE         _IOR(NVP6124_IOC_MAGIC,  10, struct nvp6124_ioc_data_t)
#define NVP6124_SET_HUE         _IOWR(NVP6124_IOC_MAGIC, 11, struct nvp6124_ioc_data_t)

#define NVP6124_GET_SHARPNESS   _IOR(NVP6124_IOC_MAGIC,  12, struct nvp6124_ioc_data_t)
#define NVP6124_SET_SHARPNESS   _IOWR(NVP6124_IOC_MAGIC, 13, struct nvp6124_ioc_data_t)

#define NVP6124_GET_INPUT_VFMT  _IOR(NVP6124_IOC_MAGIC,  14, struct nvp6124_ioc_data_t)

#define NVP6124_GET_VOL         _IOR(NVP6124_IOC_MAGIC,  16, int)
#define NVP6124_SET_VOL         _IOWR(NVP6124_IOC_MAGIC, 17, int)

#define NVP6124_GET_OUT_CH      _IOR(NVP6124_IOC_MAGIC,  18, int)
#define NVP6124_SET_OUT_CH      _IOWR(NVP6124_IOC_MAGIC, 19, int)
...
int nvp6124_video_set_output_format(int id, int ch, NVP6124_VFMT_T vfmt_idx, int vmode);
