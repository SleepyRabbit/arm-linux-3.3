...
#define ISP_IOC_SET_SENSOR_RESET        _IOW(ISP_IOC_SENSOR, 20, u32)
...
#define AE_IOC_GET_EXP_US_MODE          _IOR(ISP_IOC_AE, 40, int)
...
#define AWB_IOC_GET_SKIP_FNUM           _IOR(ISP_IOC_AWB, 14, int)
#define AWB_IOC_SET_SKIP_FNUM           _IOW(ISP_IOC_AWB, 14, int)
